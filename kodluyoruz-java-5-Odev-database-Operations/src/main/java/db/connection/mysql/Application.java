...
public class Application {
	...
	public static void listActiveManagers(ManagerService managerService) {
		...
		List<Manager> activeManagers = managerService.activeAllManager();
		Iterator<Manager> iterator = activeManagers.iterator();
	...
	public static void listDepartments(DepartmentService departmentService) {
		...
		List<Department> departments = departmentService.allDepartmentList();
